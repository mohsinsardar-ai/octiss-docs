...
| v3.2 | 20-Jun-2026 | Intelligence Sprint: RAID Engines 1+2+3 (Evidence Scanner / Downstream Impact Mapper / Intelligence Feed Panel), CR Intelligence Layer (CR_SCOPE_DRIFT alert + /change-requests/prefill endpoint + Detect Scope Drift button), Storage Intelligence starting. Schema: risks.impact_map JSONB, project_wricef.cr_ref TEXT. Bug fix: _safe_rows() for missing project_change_requests.wricef_refs. FE 40c10b0 / BE eceb402. |
